...
local states =
{
    State
    {
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("Hamlet/common/crafted/sprinkler/on")
    ...
    State
    {
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("Hamlet/common/crafted/sprinkler/off")
    ...
    State
    {
        ...
        onenter = function(inst)
            if not inst.SoundEmitter:PlayingSound("firesuppressor_idle") then
                inst.SoundEmitter:PlaySound("Hamlet/common/crafted/sprinkler/working", "firesuppressor_idle")
            end
